      ...
      <div className="container">
        <div className="about-us-heading">
          ...
          <div className="aboutus-logo-container">
            ...
            <h1 className="aboutus-logo-text">Movie Mate</h1>
          </div>
        </div>
        <div className="about-us-body">
          <p>Welcome to Movie Mate,</p>
          <p>
            At Movie Mate, we are passionate about delivering the ultimate
          ...
          <p>
            Join us at Movie Mate and immerse yourself in the captivating world
